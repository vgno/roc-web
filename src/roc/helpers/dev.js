 ...
 *
 * If no port is given it will first default to the enviorment variable `DEV_PORT` and after that `roc.config.js`.
 *
 ...
 * @returns {string} The complete dev path on the serverm including the port.
 */
